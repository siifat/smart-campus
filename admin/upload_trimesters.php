    ...
    <div class="container">
        ...
        <div class="glass-card">
            ...
            <form method="POST" enctype="multipart/form-data" id="uploadForm">
                ...
                <div style="text-align: center; margin-top: 30px; display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                    ...
                    <a href="download_template.php?type=trimesters" class="btn btn-secondary">
        ...
        <div class="glass-card">
            ...
            <div class="format-guide">
                ...
                <pre>trimester_code,trimester_name,trimester_type,year,start_date,end_date,is_current
Fall2024,Fall 2024,Fall,2024,2024-09-01,2024-12-20,1
Spring2024,Spring 2024,Spring,2024,2024-01-15,2024-05-10,0
Summer2024,Summer 2024,Summer,2024,2024-06-01,2024-08-15,0</pre>
                <ul>
                    <li><code>trimester_code</code>: Unique identifier (e.g., Fall2024)</li>
                    <li><code>trimester_name</code>: Display name (e.g., Fall 2024)</li>
                    <li><code>trimester_type</code>: Season (Fall, Spring, or Summer)</li>
                    <li><code>year</code>: Academic year (YYYY)</li>
                ...
                <p style="margin-top: 15px; color: #f68b1f; font-weight: 600;">
                    <i class="fas fa-info-circle"></i> Note: Only ONE trimester can be set as current. Setting a new current will unset previous.
                </p>
            </div>
        </div>
        ...
        <div class="glass-card">
            <h2 style="color: var(--text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 10px; font-size: 1.5rem; font-weight: 600;">
                ...
                <span style="background: linear-gradient(135deg, #f68b1f, #fbbf24); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.9rem; margin-left: 10px;">
                    <?php echo count($existing_trimesters); ?>
                </span>
            </h2>
            ...
            <?php if (empty($existing_trimesters)): ?>
                <div class="empty-state">
                    ...
                    <p style="font-size: 1.1rem; margin-top: 10px;">No trimesters found. Upload a file to add trimesters.</p>
                </div>
            <?php else: ?>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-graduation-cap"></i> Name</th>
                        ...
                        <tbody>
                            <?php foreach ($existing_trimesters as $trim): ?>
                                <tr>
                                    <td><strong style="color: #f68b1f;"><?php echo htmlspecialchars($trim['trimester_code']); ?></strong></td>
                                    <td><?php echo htmlspecialchars($trim['trimester_name']); ?></td>
                                    <td>
                                        <?php
                                        $type = strtolower($trim['trimester_type']);
                                        $badge_class = 'badge-fall';
                                        if ($type == 'spring') $badge_class = 'badge-spring';
                                        if ($type == 'summer') $badge_class = 'badge-summer';
                                        ?>
                                        <span class="badge <?php echo $badge_class; ?>">
                                            <?php echo strtoupper($trim['trimester_type']); ?>
                                        </span>
                                    </td>
                                    <td><strong><?php echo $trim['year']; ?></strong></td>
