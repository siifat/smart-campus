<?php
/**
 * Upload Departments from CSV/Excel/PDF
 */
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
    ...
    if (!in_array($file_ext, $allowed)) {
        ...
        if ($file_ext === 'csv') {
            ...
            // For now, show instructions to convert to CSV
            $message = 'For Excel files, please save as CSV format first, then upload. Or install PhpSpreadsheet library for direct Excel support.';
            $message_type = 'warning';
        }
        
        // Insert departments
        if (!empty($departments) && $message_type !== 'warning') {
            $inserted = 0;
            $skipped = 0;
            
            foreach ($departments as $dept) {
                $stmt = $conn->prepare("INSERT INTO departments (department_code, department_name) VALUES (?, ?) ON DUPLICATE KEY UPDATE department_name = VALUES(department_name)");
                $stmt->bind_param('ss', $dept['code'], $dept['name']);
            ...
            $message = "✅ Upload complete! Inserted/Updated: $inserted departments. Skipped (duplicates): $skipped";
...
$result = $conn->query("SELECT * FROM departments ORDER BY department_code");
$existing_departments = $result->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Upload Departments - Admin</title>
    ...
    <div class="container">
        ...
        <div class="glass-card">
            ...
            <form method="POST" enctype="multipart/form-data" id="uploadForm">
                <div class="upload-area" id="uploadArea" onclick="document.getElementById('fileInput').click()">
                    ...
                    <p style="margin-top: 10px;">Supported formats: CSV, Excel (.xlsx, .xls)</p>
                    <p id="fileName"></p>
                </div>
                ...
                <div style="text-align: center; margin-top: 30px; display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                    ...
                    <a href="download_template.php?type=departments" class="btn btn-secondary">
        ...
        <div class="glass-card">
            ...
            <div class="format-guide">
                <strong style="color: var(--text-primary); font-size: 1.1rem;">CSV Format Requirements:</strong>
                <ul>
                    <li>First row should be headers: <code>department_code,department_name</code></li>
                    <li>Department code should be unique (e.g., CSE, EEE, BBA)</li>
                    <li>Department name should be descriptive</li>
                    <li>Use UTF-8 encoding for special characters</li>
                </ul>
                
                <strong style="color: var(--text-primary); font-size: 1.1rem; display: block; margin-top: 20px;">Example CSV Content:</strong>
                <pre>department_code,department_name
        ...
        <div class="glass-card">
            <h2 style="color: var(--text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 10px; font-size: 1.5rem; font-weight: 600;">
                ...
                <span style="background: linear-gradient(135deg, #f68b1f, #fbbf24); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.9rem; margin-left: 10px;">
                    <?php echo count($existing_departments); ?>
                </span>
            </h2>
            
            <?php if (empty($existing_departments)): ?>
                <div class="empty-state">
                    <i class="fas fa-inbox"></i>
                    <p style="font-size: 1.1rem; margin-top: 10px;">No departments found. Upload a file to add departments.</p>
                </div>
            <?php else: ?>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-university"></i> Department Name</th>
                        ...
                        <tbody>
                            <?php foreach ($existing_departments as $dept): ?>
                                <tr>
                                    ...
                                    <td><strong style="color: #f68b1f;"><?php echo htmlspecialchars($dept['department_code']); ?></strong></td>
